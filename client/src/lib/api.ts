...
// Use relative URL in production (works with Nginx proxy) or localhost in development
...
export const projectsAPI = {
  ...
  addMember: (id: string, userEmail: string) =>
    api.post(`/projects/${id}/members`, { userEmail }),
};
